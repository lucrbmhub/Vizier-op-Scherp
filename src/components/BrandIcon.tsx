...
export type BrandIconName = "vizier" | "gesprek" | "stap" | "traject" | "vertrouwelijk";
  ...
  switch (name) {
    ...
    case "gesprek":
      return (
        <svg {...shared}>
          <path
            d="M38 20 L62 44 L38 68 L14 44 Z"
            stroke={ink}
            strokeWidth={sw}
            strokeLinejoin="round"
          />
          <path
            d="M62 32 L86 56 L62 80 L38 56 Z"
            stroke={koraal}
            strokeWidth={sw}
            strokeLinejoin="round"
          />
    ...
    case "traject":
      return (
        <svg {...shared}>
          <path
            d="M28 62 L40 74 L28 86 L16 74 Z"
            stroke={ink}
            strokeWidth={sw}
            strokeLinejoin="round"
          />
    ...
    case "vertrouwelijk":
      return (
        <svg {...shared}>
          ...
          />
          <path
            d="M50 36 L64 50 L50 64 L36 50 Z"
            stroke={koraal}
            strokeWidth={sw}
            strokeLinejoin="round"
          />
