...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Loopbaancoaching en ontwikkelpartner voor werkgevers, medewerkers en UWV-cliënten in Amsterdam, Haarlem en omgeving." },
      { name: "twitter:description", content: "Loopbaancoaching en ontwikkelpartner voor werkgevers, medewerkers en UWV-cliënten in Amsterdam, Haarlem en omgeving." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400;12..96,500;12..96,600&family=Instrument+Sans:wght@400;500;600&display=swap",
      },
    ],
  }),
